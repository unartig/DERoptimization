...
from pyomo.environ import ConcreteModel, Param, Var, maximize, Objective, Constraint, \
    Set, Expression, Integers, Piecewise, Expr_if, PositiveIntegers, Binary, NonNegativeReals, Reals
...
def t2_battery_model(electricity_price, power_production, critical_t):
